@component('layouts.admin.master')
    ...
    @section('content')
        <div class="title-block">
            <h3 class="title"><i class="fa fa-map-pin"></i> Add Area <span class="sparkline bar"
                                                                                data-type="bar"></span></h3>
        </div>
        <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.areas.store') }}">
            {{ csrf_field() }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="name" class="form-control boxed" id="name"
                               placeholder="Enter Area Name" value="{{ old('name') }}" autofocus>
                        @if ($errors->has('name'))
