        ...
        <div class="card-block">
            ...
            {{--<div class="row row-sm stats-container">--}}
                ...
                {{--<div class="col-12 col-sm-6 stat-col">--}}
                    ...
                    {{--<div class="stat">--}}
                        {{--<div class="value"> {{ $total_live_posts }}--}}
                            {{--({{ $posts->total() > 0 ? number_format(($total_live_posts / $posts->total()) * 100, 2) : 0 }}%)--}}
                        {{--</div>--}}
                        {{--<div class="name"> Live posts</div>--}}
                    {{--</div>--}}
                    {{--<progress class="progress stat-progress"--}}
                              {{--value="{{ $posts->total() > 0 ? number_format(($total_live_posts / $posts->total()) * 100, 2) : 0 }}" max="100">--}}
                        {{--<div class="progress">--}}
                            {{--<span class="progress-bar"--}}
                                  {{--style="width: {{ $posts->total() > 0 ? number_format(($total_live_posts / $posts->total()) * 100, 2) : 0 }}%;"></span>--}}
                        {{--</div>--}}
                    {{--</progress>--}}
                {{--</div>--}}
                {{--<div class="col-12 col-sm-6  stat-col">--}}
                ...
                {{--<div class="col-12 col-sm-6  stat-col">--}}
                    {{--<div class="stat-icon"><i class="fa fa-users"></i></div>--}}
                    {{--<div class="stat">--}}
                        {{--<div class="value"> {{ $users_with_posts }}--}}
                            {{--({{ $total_users > 0 ? number_format(($users_with_posts / $total_users) * 100, 2) : 0 }}%)--}}
                        {{--</div>--}}
                        {{--<div class="name"> Users + (posts)</div>--}}
                    {{--</div>--}}
                    {{--<progress class="progress stat-progress"--}}
                              {{--value="({{ $total_users > 0 ? number_format(($users_with_posts / $total_users) * 100, 2) : 0 }}%)" max="100">--}}
                        {{--<div class="progress">--}}
                            {{--<span class="progress-bar"--}}
                                  {{--style="width: {{ $total_users > 0 ? number_format(($users_with_posts / $total_users) * 100, 2) : 0 }}%;"></span>--}}
                        {{--</div>--}}
                    {{--</progress>--}}
                {{--</div>--}}
                {{--<div class="col-12 col-sm-6 stat-col">--}}
                    ...
                    {{--<div class="stat">--}}
                        {{--<div class="value"> {{ $users_with_live_posts }}--}}
                            {{--({{ $total_users > 0 ? number_format(($users_with_live_posts / $total_users) * 100, 2) : 0 }}%)--}}
                        {{--</div>--}}
                        {{--<div class="name"> Users + (live posts)</div>--}}
                    {{--</div>--}}
                    {{--<progress class="progress stat-progress"--}}
                              {{--value="({{ $total_users > 0 ? number_format(($users_with_live_posts / $total_users) * 100, 2) : 0 }}%)" max="100">--}}
                        {{--<div class="progress">--}}
                            {{--<span class="progress-bar"--}}
                                  {{--style="width: {{ $total_users > 0 ? number_format(($users_with_live_posts / $total_users) * 100, 2) : 0 }}%;"></span>--}}
                        {{--</div>--}}
                    {{--</progress>--}}
                {{--</div>--}}
                {{--<div class="col-12 col-sm-6 stat-col">--}}
